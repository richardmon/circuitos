/* 
 ...
 Modifed version due to the change of a servo for a stepper motor
  */
...
// Initialize steppers for X-axis,Y-axis and Z-axis using this Arduino pins for the L293D H-bridge
Stepper myStepperY(stepsPerRevolution, 2,3,4,5);            
Stepper myStepperX(stepsPerRevolution, 8,9,10,11);
Stepper myStepperZ(stepsPerRevolution, A0,A1,A2,A3);
